...
class FedArguments:
    ...
    num_clients: Optional[int] = field(default=4, metadata={"help": "the number of clients"})
    sample_clients: Optional[int] = field(default=4, metadata={"help": "the number of clients to sample"})
...
class ScriptArguments:
    ...
    model_name_or_path: Optional[str] = field(default="meta-llama/Llama-3.2-3B", metadata={"help": "the model name"})#meta-llama/Llama-2-7b-hf,meta-llama/Llama-3.2-3B hf-models/Llama-3.2-1B-Instruct
    dataset_name: Optional[str] = field(
        default="imdb", metadata={"help": "the dataset name"}#"HuggingFaceH4/ultrafeedback_binarized"vicgalle/alpaca-gpt4 TIGER-Lab/MathInstruct  vicgalle/alpaca-gpt4 imdb
    )
    log_with: Optional[str] = field(default="none", metadata={"help": "use 'wandb' to log with wandb"})
    learning_rate: Optional[float] = field(default=5e-5, metadata={"help": "the learning rate"})    # vicuna and alpaca use 2e-5  meta-llama/Llama-2-7b-hf
    batch_size: Optional[int] = field(default=32, metadata={"help": "the batch size"})#16
    ...
    output_dir: Optional[str] = field(default="./output/yigou-3B", metadata={"help": "the output directory"})
...
#'data1/jinni/first/OpenFedLLM-main/vicgalle/alpaca-gpt4/'
...
def get_model_config(script_args):
    if script_args.load_in_8bit and script_args.load_in_4bit:
        ...
        # Copy the model to each device Accelerator().local_process_index
