...
answer_file = f"./data/mtbench/model_answer/yigou/{model_name}.jsonl"
print(answer_file)
# ============= Load model and tokenizer =============
model = AutoModelForCausalLM.from_pretrained(args.base_model_path, torch_dtype=torch.float16).to(
    'cuda')  # float16 to run inference of 7B model on 3090 GPU
if args.lora_path:
