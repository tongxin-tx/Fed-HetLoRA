...
parser.add_argument("--base_model_path", type=str, default="/data1/jinni/first/OpenFedLLM-main/output/alpaca-gpt4_20000_fedavg_c5s5_i10_b16a1_l512_r16a64_20241201153132/full-30")#meta-llama/Llama-2-7b-hf
...
if args.bench_name == "alpaca":
    ...
    # eval_set = eval_set.map(lambda example: {'turns': [example['turns']+' Instantly.']})
    # eval_set['instruction']=eval_set['instruction']+"Instantly."
